...
if not deepseek_api_key:
    raise RuntimeError(
        "未检测到环境变量 DEEPSEEK_API_KEY，请检查 config.env 文件配置。"
    )

# 配置大模型
# DeepSeek 兼容 OpenAI API，因此可以通过 base_url 进行配置
llm_config = {
    "config_list": [
        {
            "model": "deepseek-chat",
...
# 定义芯片人才的运营任务
inventory_tasks = [
    """查看当前我国各种芯片人才的数量，并报告哪些芯片人才不足。""",
    """根据过去一年的销售数据，预测接下来一年哪些芯片人才的需求量会增加。""",
]

market_research_tasks = [
    """分析市场趋势，找出当前最受欢迎的芯片人才种类及其可能的原因。"""
]

content_creation_tasks = [
    """利用提供的信息，撰写一篇吸引人的博客文章，介绍最受欢迎的芯片人才及获取来源。"""
]
